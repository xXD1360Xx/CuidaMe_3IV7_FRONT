...
// Colores de CuidaMe (estandarizados)
const COLORES = {
  AZUL_CIELO: '#87CEEB',
...
export default function VistaPreferencias({ navigation }) {
  ...
  const [preferencias, setPreferencias] = useState({
    notificaciones: true,
    notificacionesMedicinas: true,
    notificacionesEventos: true,
    notificacionesGastos: true,
  ...
  const actualizarInformacionUsuario = async () => {
    try {
      if (!usuario) return;
      const datosActualizar = { email: usuario.email };
  ...
  const eliminarTelefono = (telefonoId) => {
    Alert.alert(
      'Eliminar Teléfono',
      '¿Estás seguro de eliminar este número?',
      [
    ...
    try {
      if (!hayOtroAdmin) {
        Alert.alert(
          ...
          'Debes designar a otro familiar como administrador antes de renunciar.',
      ...
      if (response.exito) {
        Alert.alert('Éxito', 'Has renunciado al rol de administrador', [
          {
            text: 'Aceptar',
            onPress: async () => {
        ...
        { text: 'Cancelar', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              if (response.exito) {
                Alert.alert('Solicitud Enviada', 'Tu solicitud ha sido enviada al administrador.');
              }
            } catch (error) {
        ...
        >
          ...
          <View style={styles.seccion}>
            ...
            <View style={styles.contenedorPerfil}>
              <TouchableOpacity style={styles.contenedorFotoPerfil} onPress={seleccionarFotoPerfil}>
          ...
          <View style={styles.seccion}>
            ...
            <View style={styles.contenedorInformacion}>
              ...
              <TouchableOpacity style={styles.botonGuardarCambios} onPress={actualizarInformacionUsuario}>
          ...
          <View style={styles.seccion}>
            <View style={styles.encabezadoSeccionConBoton}>
              ...
              <TouchableOpacity style={styles.botonAgregarTelefono} onPress={() => setModalTelefonoVisible(true)}>
                  ...
                  <View key={telefono.id} style={styles.itemTelefono}>
                    <View style={styles.infoTelefono}>
                      <View style={styles.iconoTipoTelefono}>
                        <Icon
                          name={
                            TIPOS_TELEFONO.find((t) => t.id === telefono.tipo)?.icono || 'call-outline'
                          }
                          size={18}
                    ...
                    <View style={styles.accionesTelefono}>
                      {!telefono.principal && (
                        <TouchableOpacity style={styles.botonAccionTelefono} onPress={() => marcarComoPrincipal(telefono.id)}>
                          <Icon name="star-outline" size={18} color={COLORES.AMARILLO_PLATANO} />
                        </TouchableOpacity>
                      )}
                      <TouchableOpacity style={styles.botonAccionTelefono} onPress={() => eliminarTelefono(telefono.id)}>
          ...
          <View style={styles.seccion}>
            ...
            <View style={styles.contenedorSeguridad}>
              <TouchableOpacity style={styles.itemAccion} onPress={() => setModalContrasenaVisible(true)}>
            ...
            <View style={styles.contenedorNotificaciones}>
              <View style={styles.itemToggle}>
                <View style={styles.infoToggle}>
                  ...
                  <View style={styles.textosToggle}>
                    <Text style={styles.tituloToggle}>Activar Notificaciones</Text>
              ...
              <View style={styles.itemToggle}>
                <View style={styles.infoToggle}>
                  <Icon name="medkit-outline" size={22} color={COLORES.ROJO_CLARO} />
                  <View style={styles.textosToggle}>
                    <Text style={styles.tituloToggle}>Medicinas</Text>
                    <Text style={styles.descripcionToggle}>Recordatorios de medicinas</Text>
                  </View>
                </View>
                <Switch
                  value={preferencias.notificacionesMedicinas}
                  onValueChange={(valor) => actualizarPreferencia(null, 'notificacionesMedicinas', valor)}
                  trackColor={{ false: COLORES.GRIS_MEDIO, true: COLORES.ROJO_CLARO }}
                  thumbColor={COLORES.BLANCO}
              ...
              <View style={styles.itemToggle}>
                <View style={styles.infoToggle}>
                  <Icon name="calendar-outline" size={22} color={COLORES.MORADO} />
                  <View style={styles.textosToggle}>
                    <Text style={styles.tituloToggle}>Eventos</Text>
                    <Text style={styles.descripcionToggle}>Recordatorios de eventos y citas</Text>
                  </View>
                </View>
                <Switch
                  value={preferencias.notificacionesEventos}
                  onValueChange={(valor) => actualizarPreferencia(null, 'notificacionesEventos', valor)}
              ...
              <View style={styles.itemToggle}>
                <View style={styles.infoToggle}>
                  <Icon name="cash-outline" size={22} color={COLORES.NARANJA} />
                  <View style={styles.textosToggle}>
                    <Text style={styles.tituloToggle}>Gastos</Text>
                    <Text style={styles.descripcionToggle}>Notificaciones sobre gastos</Text>
                  </View>
                </View>
                <Switch
                  value={preferencias.notificacionesGastos}
                  onValueChange={(valor) => actualizarPreferencia(null, 'notificacionesGastos', valor)}
                  trackColor={{ false: COLORES.GRIS_MEDIO, true: COLORES.NARANJA }}
                  thumbColor={COLORES.BLANCO}
                  disabled={!preferencias.notificaciones}
                />
              </View>
              ...
              <View style={styles.itemToggle}>
                <View style={styles.infoToggle}>
                  <Icon name="volume-high-outline" size={22} color={COLORES.TURQUESA} />
                  <View style={styles.textosToggle}>
              ...
              <View style={styles.itemToggle}>
                <View style={styles.infoToggle}>
                  <Icon name="phone-portrait-outline" size={22} color={COLORES.INDIGO} />
                  <View style={styles.textosToggle}>
                    ...
                    >
                      <Text
                        style={[
                          ...
                          preferencias.tamanoLetra === tamano.id &&
                          styles.textoOpcionTamanioSeleccionada,
                        ]}
                      >
                        Aa
                      </Text>
                      <Text
                        style={[
                          ...
                          preferencias.tamanoLetra === tamano.id &&
                          styles.labelOpcionTamanioSeleccionada,
                        ]}
                      >
                        {tamano.nombre}
                      </Text>
                  ...
                  {IDIOMAS.map((idioma) => (
                    ...
                    >
                      <Icon
                        ...
                        size={16}
                        color={
                          preferencias.idioma === idioma.id ? COLORES.BLANCO : COLORES.GRIS_OSCURO
                        }
                      />
                      <Text
                        style={[
                          styles.textoOpcionIdioma,
                          preferencias.idioma === idioma.id &&
                          styles.textoOpcionIdiomaSeleccionada,
                        ]}
                      >
                        {idioma.nombre}
                      </Text>
          ...
          {esAdministrador && (
            <View style={styles.seccion}>
              ...
              <View style={styles.contenedorAdministracion}>
                <TouchableOpacity style={styles.itemAccionEspecial} onPress={() => setModalRenunciarVisible(true)}>
                  <View style={[styles.iconoAccionEspecial, { backgroundColor: COLORES.AMARILLO_PLATANO + '20' }]}>
                    <Icon name="shield-outline" size={22} color={COLORES.AMARILLO_OSCURO} />
                  </View>
          ...
          <View style={styles.seccion}>
            ...
            <View style={styles.contenedorCuenta}>
              <TouchableOpacity style={styles.itemAccion} onPress={cerrarSesion}>
                <View style={[styles.iconoAccionItem, { backgroundColor: COLORES.ROJO_CLARO + '20' }]}>
              ...
              <TouchableOpacity style={styles.itemAccion} onPress={solicitarEliminarCuenta}>
          ...
          <View style={styles.seccion}>
            <View style={styles.infoApp}>
              ...
              <TouchableOpacity style={styles.botonSoporte} onPress={() => navigation.navigate('Soporte')}>
          ...
          <TouchableWithoutFeedback>
            <View style={styles.modalContenido}>
                  ...
                  {TIPOS_TELEFONO.map((tipo) => (
                    ...
                    >
                      <Icon
                        ...
                        size={18}
                        color={
                          nuevoTelefono.tipo === tipo.id ? COLORES.BLANCO : COLORES.GRIS_OSCURO
                        }
                      />
                      <Text
                        style={[
                          styles.textoOpcionTipoTelefono,
                          nuevoTelefono.tipo === tipo.id &&
                          styles.textoOpcionTipoTelefonoSeleccionada,
                        ]}
                      >
                        {tipo.nombre}
                      </Text>
              ...
              <View style={styles.modalBotones}>
                <TouchableOpacity style={styles.botonModalCancelar} onPress={() => setModalTelefonoVisible(false)}>
        ...
        >
          <TouchableWithoutFeedback>
            <View style={styles.modalContenido}>
              ...
              <View style={styles.modalBotones}>
                <TouchableOpacity style={styles.botonModalCancelar} onPress={() => setModalContrasenaVisible(false)}>
                  <Text style={styles.textoBotonModalCancelar}>Cancelar</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.botonModalAccion, { backgroundColor: COLORES.EXITO }]}
        ...
        >
          <TouchableWithoutFeedback>
            <View style={styles.modalContenido}>
                  ...
                  <>
                    <View style={styles.listaConsecuencias}>
                      <View style={styles.itemConsecuencia}>
                        ...
                        <Text style={styles.textoConsecuencia}>
                          No podrás agregar o eliminar familiares
                        </Text>
                      </View>
                      <View style={styles.itemConsecuencia}>
                        <Icon name="close-circle-outline" size={18} color={COLORES.ROJO_CLARO} />
                        <Text style={styles.textoConsecuencia}>
                          No podrás generar códigos familiares
                        </Text>
                      </View>
                      <View style={styles.itemConsecuencia}>
                        <Icon name="close-circle-outline" size={18} color={COLORES.ROJO_CLARO} />
                        <Text style={styles.textoConsecuencia}>
                          No podrás configurar porcentajes de gastos
                        </Text>
                      </View>
                      <View style={styles.itemConsecuencia}>
                        <Icon name="close-circle-outline" size={18} color={COLORES.ROJO_CLARO} />
                        <Text style={styles.textoConsecuencia}>
                          No podrás editar información del adulto mayor
                        </Text>
                      </View>
                    </View>
              ...
              <View style={styles.modalBotones}>
                <TouchableOpacity style={styles.botonModalCancelar} onPress={() => setModalRenunciarVisible(false)}>
                  <Text style={styles.textoBotonModalCancelar}>Cancelar</Text>
                </TouchableOpacity>
                {hayOtroAdmin && (
                  <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  tituloSeccion: { fontSize: 18, fontWeight: 'bold', color: COLORES.TEXTO_OSCURO, marginBottom: 14 },
  ...
  botonAgregarTelefono: { padding: 6 },
  ...
  contenedorFotoPerfil: { position: 'relative', marginRight: 16 },
  fotoPerfil: {
    width: 80,
    height: 80,
    borderRadius: 40,
  ...
  infoPerfil: { flex: 1 },
  nombrePerfil: { fontSize: 20, fontWeight: 'bold', color: COLORES.TEXTO_OSCURO, marginBottom: 4 },
  emailPerfil: { fontSize: 14, color: COLORES.GRIS_OSCURO, marginBottom: 6 },
  badgeRol: {
  ...
  textoBadgeRol: { fontSize: 12, color: COLORES.AMARILLO_OSCURO, fontWeight: '600' },
  ...
  itemInformacion: { marginBottom: 16 },
  labelInformacion: { flexDirection: 'row', alignItems: 'center', marginBottom: 6 },
  textoLabelInformacion: { fontSize: 14, fontWeight: '600', color: COLORES.TEXTO_OSCURO, marginLeft: 8 },
  valorInformacion: {
    fontSize: 16,
  ...
  textoBotonGuardarCambios: { color: COLORES.BLANCO, fontSize: 16, fontWeight: '600' },
  ...
  infoTelefono: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  iconoTipoTelefono: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  detallesTelefono: { flex: 1 },
  numeroTelefono: { fontSize: 16, fontWeight: '600', color: COLORES.TEXTO_OSCURO, marginBottom: 2 },
  tipoTelefono: { fontSize: 12, color: COLORES.GRIS_OSCURO },
  accionesTelefono: { flexDirection: 'row' },
  botonAccionTelefono: { padding: 6 },
  textoSinTelefonos: { textAlign: 'center', color: COLORES.GRIS_OSCURO, paddingVertical: 16, fontStyle: 'italic' },
  ...
  infoAccion: { flex: 1 },
  tituloAccion: { fontSize: 16, fontWeight: '600', color: COLORES.TEXTO_OSCURO, marginBottom: 2 },
  descripcionAccion: { fontSize: 13, color: COLORES.GRIS_OSCURO },
  ...
  infoAccionEspecial: { flex: 1 },
  tituloAccionEspecial: { fontSize: 16, fontWeight: '600', color: COLORES.AMARILLO_OSCURO, marginBottom: 2 },
  descripcionAccionEspecial: { fontSize: 13, color: COLORES.GRIS_OSCURO },
  ...
  infoToggle: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  textosToggle: { flex: 1, marginLeft: 14 },
  tituloToggle: { fontSize: 16, fontWeight: '600', color: COLORES.TEXTO_OSCURO, marginBottom: 2 },
  descripcionToggle: { fontSize: 13, color: COLORES.GRIS_OSCURO },

  // Selectores
  itemSelector: { paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: COLORES.GRIS_CLARO },
  infoSelector: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
  textosSelector: { flex: 1, marginLeft: 14 },
  tituloSelector: { fontSize: 16, fontWeight: '600', color: COLORES.TEXTO_OSCURO, marginBottom: 2 },
  descripcionSelector: { fontSize: 13, color: COLORES.GRIS_OSCURO },
  opcionesTamanio: { flexDirection: 'row', justifyContent: 'space-between' },
  opcionTamanio: {
    flex: 1,
    alignItems: 'center',
    padding: 8,
  ...
  opcionTamanioSeleccionada: { backgroundColor: COLORES.AZUL_CIELO, borderColor: COLORES.AZUL_CIELO_OSCURO },
  textoOpcionTamanio: { fontSize: 16, color: COLORES.GRIS_OSCURO, marginBottom: 2 },
  textoOpcionTamanioSeleccionada: { color: COLORES.BLANCO, fontWeight: 'bold' },
  labelOpcionTamanio: { fontSize: 10, color: COLORES.GRIS_OSCURO },
  labelOpcionTamanioSeleccionada: { color: COLORES.BLANCO, fontWeight: 'bold' },

  opcionesIdioma: { flexDirection: 'row' },
  opcionIdioma: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  opcionIdiomaSeleccionada: { backgroundColor: COLORES.AZUL_CIELO, borderColor: COLORES.AZUL_CIELO_OSCURO },
  textoOpcionIdioma: { fontSize: 12, color: COLORES.GRIS_OSCURO, marginLeft: 6 },
  textoOpcionIdiomaSeleccionada: { color: COLORES.BLANCO, fontWeight: 'bold' },

  // Información de la App
  infoApp: { alignItems: 'center', paddingVertical: 16 },
  versionApp: { fontSize: 14, color: COLORES.GRIS_OSCURO, marginBottom: 6 },
  copyApp: { fontSize: 12, color: COLORES.GRIS_MEDIO, marginBottom: 12 },
  botonSoporte: { paddingVertical: 8, paddingHorizontal: 16 },
  textoBotonSoporte: { color: COLORES.AZUL_CIELO_OSCURO, fontSize: 14, fontWeight: '500' },
  ...
  modalFormulario: { maxHeight: 400, paddingHorizontal: 4 },
  ...
  opcionesTipoTelefono: { flexDirection: 'row', flexWrap: 'wrap', marginBottom: 12 },
  opcionTipoTelefono: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 12,
  ...
  opcionTipoTelefonoSeleccionada: { backgroundColor: COLORES.AZUL_CIELO, borderColor: COLORES.AZUL_CIELO_OSCURO },
  textoOpcionTipoTelefono: { fontSize: 12, color: COLORES.GRIS_OSCURO, marginLeft: 6 },
  textoOpcionTipoTelefonoSeleccionada: { color: COLORES.BLANCO, fontWeight: 'bold' },

  opcionPrincipal: { marginBottom: 12 },
  botonCheckbox: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8 },
  textoCheckbox: { fontSize: 14, color: COLORES.TEXTO_OSCURO, marginLeft: 10 },
  ...
  tituloConsejos: { fontSize: 14, fontWeight: 'bold', color: COLORES.TEXTO_OSCURO, marginBottom: 6 },
  textoConsejos: { fontSize: 13, color: COLORES.GRIS_OSCURO, marginBottom: 2 },

  // Renunciar admin
  infoAdvertencia: { alignItems: 'center', marginBottom: 16 },
  tituloAdvertencia: { fontSize: 18, fontWeight: 'bold', color: COLORES.AMARILLO_OSCURO, marginTop: 8, marginBottom: 4 },
  textoAdvertencia: { fontSize: 14, color: COLORES.GRIS_OSCURO, textAlign: 'center', lineHeight: 20 },
  listaConsecuencias: { marginBottom: 16 },
  itemConsecuencia: { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 10 },
  textoConsecuencia: { fontSize: 14, color: COLORES.TEXTO_OSCURO, marginLeft: 10, flex: 1, lineHeight: 20 },
  textoConfirmacion: { fontSize: 14, color: COLORES.TEXTO_OSCURO, textAlign: 'center', fontStyle: 'italic' },
  botonDesignarAdmin: {
  ...
  textoBotonDesignarAdmin: { color: COLORES.TEXTO_OSCURO, fontSize: 16, fontWeight: '600' },
